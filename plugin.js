...
// src/behaviors/reply-thread.ts
var LOG_GRID_SELECTOR = "div[class*='grid-cols-[minmax(0,1fr)]'][class*='gap-1.5'][class*='px-2.5'][class*='pb-2']";
var REPLY_LINK_SELECTOR = "button[data-variant='link']";
function isHidden(element) {
  return Boolean(element.closest("[data-pane-hidden], [inert]"));
}
function seatThreadComposers(root) {
  let seats = 0;
...
function installThreadComposerSeat(ctx) {
